...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default
               ...
               (company-preview :background ,other-blue :foreground ,other-blue)
               ...
               (company-tooltip :foreground ,dracula-fg :background ,bg2)
               ...
               (company-tooltip-mouse :background ,dracula-fg)        
